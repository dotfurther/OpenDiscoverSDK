# TotalNumOfDocumentRecordsWritten Property


Total number of document records written to the load file.
...
**C#**
``` C#
[JsonPropertyNameAttribute("TotalNumOfDocumentRecordsWritten")]
public int TotalNumOfDocumentRecordsWritten { get; set; }
```
