# MessageDeliveryTime Field


Email object associated metadata field (for Outlook message objects correspods to MAPI PidTagMessageDeliveryTime property)
...
public const string MessageDeliveryTime = "MessageDeliveryTime"
```
