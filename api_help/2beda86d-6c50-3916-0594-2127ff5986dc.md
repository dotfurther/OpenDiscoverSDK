# CompressionSpaceSavings Field


Archive space savings. Calculated metadata which is defined as reduction in size relative to the uncompressed size (given in percent).
...
public const string CompressionSpaceSavings = "CompressionSpaceSavings"
```
