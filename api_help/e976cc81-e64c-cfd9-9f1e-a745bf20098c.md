# InputDocumentQueueCount Property


If a task is running, returns the current number of documents waiting to be read for processing.
...
**C#**
``` C#
public int InputDocumentQueueCount { get; }
```
