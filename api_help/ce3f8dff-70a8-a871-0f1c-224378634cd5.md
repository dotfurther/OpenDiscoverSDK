# DeferredDeliveryTime Field


Contains the date and time, in UTC, at which the sender prefers that the message be delivered (corresponds to MAPI PidTagDeferredDeliveryTime property).
...
public const string DeferredDeliveryTime = "DeferredDeliveryTime"
```
