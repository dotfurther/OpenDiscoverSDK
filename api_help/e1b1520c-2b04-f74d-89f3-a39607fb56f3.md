# MessagingTypeMetadataFields Property


Messaging type metadata fields (see <a href="a4b5275b-c507-047c-66df-6eb5d206a3a3">KnownMetadataField</a>, e.g., Teams, Slack, etc., message metadata).
...
**C#**
``` C#
public static List<KnownMetadataField> MessagingTypeMetadataFields { get; }
```
