# CollectedUserId Field


Messaging store export container metadata
...
**C#**
``` C#
[KnownMetadataAttribute(IsMessagingStoreType = true)]
public const string CollectedUserId = "CollectedUserId"
```
