# CurrentNumberOfMailStoresInProcess Property


If a task is running, returns the current number of mail stores (PST/OST/MBOX/etc) currently being processed.
...
**C#**
``` C#
public int CurrentNumberOfMailStoresInProcess { get; }
```
