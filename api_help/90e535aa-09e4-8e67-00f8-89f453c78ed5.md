# AttachedImageScaled Field


Outlook email document object associated metadata field (MAPI property PidNameScale).
...
public const string AttachedImageScaled = "AttachedImageScaled"
```
