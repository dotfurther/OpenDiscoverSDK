# LastAccessTimeFileSystem Field


RESERVED - Not set by SDK. User can set this property with the document's file system lass access time.
...
public const string LastAccessTimeFileSystem = "LastAccessTimeFileSystem"
```
