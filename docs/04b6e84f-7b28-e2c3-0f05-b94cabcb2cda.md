# SentRepresentingEmailAddress Field


Microsoft Outlook email object (.msg), and other email types, associated metadata.
...
public const string SentRepresentingEmailAddress = "SentRepresentingEmailAddress"
```
