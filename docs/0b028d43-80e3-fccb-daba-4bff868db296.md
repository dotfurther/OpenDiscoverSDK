# HtmlTypeMetadataFields Property


HTML document associated metadata fields (see <a href="a4b5275b-c507-047c-66df-6eb5d206a3a3">KnownMetadataField</a>).
...
**C#**
``` C#
public static List<KnownMetadataField> HtmlTypeMetadataFields { get; }
```
...
## Remarks
This list can aide in searching indexes for known HTML metadata.
