...
public class DatabaseContent : DocumentContent
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  <a href="8e86a5a1-9129-b079-8605-f7fa3f3a1f21">DocumentContent</a>  →  DatabaseContent</td></tr>
</table>
...
<tr>
<td><a href="c59a9488-c5b5-c9ba-7430-f14238a5827d">Tables</a></td>
<td>Information on all stored tables in the database.</td></tr>
<tr>
...
<tr>
<td><a href="025dfe3a-5a09-adc3-f4b3-0967ae717b3d">TotalTableRowCount</a></td>
<td>The total table row count sum across all database tables. This value may be useful in determining the workflow in processing a database that has a total table(s) row count with a very 'large' number of rows, and a database with a very 'large' number of table rows may require special workflow operations.</td></tr>
</table>
