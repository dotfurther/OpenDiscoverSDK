# LastVerbExecutionTime Field


Email object associated metadata field (for Outlook message objects corresponds to MAPI PidTagLastVerbExecutionTime property)
