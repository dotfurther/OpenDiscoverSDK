# LogDocumentSaved Field


Outlook email journal object associated metadata field (MAPI property PidLidLogDocumentSaved).
...
public const string LogDocumentSaved = "LogDocumentSaved"
```
