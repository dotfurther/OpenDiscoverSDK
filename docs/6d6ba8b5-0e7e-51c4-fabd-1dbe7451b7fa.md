# ContactUserField4 Field


Microsoft Outlook email contact object (.msg) or DXL "Person" (form-type) email object associated metadata.
...
public const string ContactUserField4 = "ContactUserField4"
```
