# LogDocumentRouted Field


Outlook email journal object associated metadata field (MAPI property PidLidLogDocumentRouted).
...
public const string LogDocumentRouted = "LogDocumentRouted"
```
