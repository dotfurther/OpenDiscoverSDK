# TaskResetReminder Field


Outlook email task object associated metadata field (MAPI property PidLidTaskResetReminder).
...
public const string TaskResetReminder = "TaskResetReminder"
```
