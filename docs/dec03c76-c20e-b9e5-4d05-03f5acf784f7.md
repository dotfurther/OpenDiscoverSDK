# OriginatorDeliveryReportRequested Field


Email object associated metadata field (corresponds to MAPI PidTagOriginatorDeliveryReportRequested property and MIME "return-receipt-to" header).
...
public const string OriginatorDeliveryReportRequested = "OriginatorDeliveryReportRequested"
```
