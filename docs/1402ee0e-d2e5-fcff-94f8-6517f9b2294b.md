# LogDocumentPrinted Field


Outlook email journal object associated metadata field (MAPI property PidLidLogDocumentPrinted).
...
public const string LogDocumentPrinted = "LogDocumentPrinted"
```
