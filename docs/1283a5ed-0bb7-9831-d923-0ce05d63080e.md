# TotalDatabasesProcessed Property


If a task is running, returns the total number of databases that have currently been fully processed.
...
**C#**
``` C#
public int TotalDatabasesProcessed { get; }
```
