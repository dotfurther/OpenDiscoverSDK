# ImportAPIWorkspaceArtifactTypeID Property
...
**C#**
``` C#
[JsonPropertyNameAttribute("ImportAPIWorkspaceArtifactTypeID")]
public int ImportAPIWorkspaceArtifactTypeID { get; set; }
```
