# TotalMailStoresProcessed Property


If a task is running, returns the total number of mail stores (PST/OST/MBOX/etc) that have currently been fully processed.
...
**C#**
``` C#
public int TotalMailStoresProcessed { get; }
```
