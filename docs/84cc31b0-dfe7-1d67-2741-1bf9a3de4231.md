# TaskFRecurring Field


Outlook email task object associated metadata field (MAPI property PidLidTaskFRecurring).
...
public const string TaskFRecurring = "TaskFRecurring"
```
