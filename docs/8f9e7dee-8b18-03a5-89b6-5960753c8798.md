# ReplyRequested Field


Outlook email object associated metadata field (corresponds to MAPI PidTagReplyRequested property).
...
public const string ReplyRequested = "ReplyRequested"
```
