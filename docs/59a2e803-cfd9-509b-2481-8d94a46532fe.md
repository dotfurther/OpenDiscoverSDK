# DeleteAfterSubmit Field


Outlook email object associated metadata field (corresponds to MAPI PidTagDeleteAfterSubmit property).
...
public const string DeleteAfterSubmit = "DeleteAfterSubmit"
```
