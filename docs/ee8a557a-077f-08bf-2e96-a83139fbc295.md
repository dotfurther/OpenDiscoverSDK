...
Represents a list of string values document metadata property.
...
[KnownTypeAttribute(typeof(DocumentPropertyBase<List<string>>))]
public class StringListProperty : DocumentPropertyBase<List<string>>
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  <a href="854c97ea-54ea-7894-e767-4da530bd8c60">DocumentPropertyBase</a>(List(String))  →  StringListProperty</td></tr>
</table>
...
<tr>
<td><a href="2212a70d-8945-940f-9b57-5908411a58ed">StringValue</a></td>
