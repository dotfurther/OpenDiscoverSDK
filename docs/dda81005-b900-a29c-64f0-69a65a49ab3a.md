# AlternateRecipientAllowed Field


Outlook email object associated metadata field (corresponds to MAPI PidTagAlternateRecipientAllowed property).
...
public const string AlternateRecipientAllowed = "AlternateRecipientAllowed"
```
