# LogDocumentPosted Field


Outlook email journal object associated metadata field (MAPI property PidLidLogDocumentPosted).
...
public const string LogDocumentPosted = "LogDocumentPosted"
```
