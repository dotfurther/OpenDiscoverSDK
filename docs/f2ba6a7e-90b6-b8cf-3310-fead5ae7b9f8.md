# LastIMReceivedTime Field


Last time Skype message was received in a chat log metadata field (this value is stored in the chat log's generated HTML metadata).
...
public const string LastIMReceivedTime = "LastIMReceivedTime"
```
