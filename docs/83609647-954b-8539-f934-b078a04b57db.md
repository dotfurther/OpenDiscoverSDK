# LastModifierName Field


Microsoft Outlook email object (.msg) associated metadata (corresponds to MAPI PidTagLastModifierName property).
...
public const string LastModifierName = "LastModifierName"
```
