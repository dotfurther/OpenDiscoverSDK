# DiskSpacePercentUsed Field


Domino DXL database metadatafield.
...
**C#**
``` C#
[KnownMetadataAttribute(IsDocumentStoreType = true)]
public const string DiskSpacePercentUsed = "DiskSpacePercentUsed"
```
