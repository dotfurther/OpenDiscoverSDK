# IsContactLinked Field


Outlook email object associated metadata field (MAPI property PidLidIsContactLinked).
...
public const string IsContactLinked = "IsContactLinked"
```
