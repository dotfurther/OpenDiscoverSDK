# TaskStatusOnComplete Field


Outlook email task object associated metadata field (MAPI property PidLidTaskStatusOnComplete).
...
public const string TaskStatusOnComplete = "TaskStatusOnComplete"
```
