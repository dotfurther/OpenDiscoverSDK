# RecipientReassignmentProhibited Field


Outlook email object associated metadata field (corresponds to MAPI PidTagRecipientReassignmentProhibited property).
...
public const string RecipientReassignmentProhibited = "RecipientReassignmentProhibited"
```
