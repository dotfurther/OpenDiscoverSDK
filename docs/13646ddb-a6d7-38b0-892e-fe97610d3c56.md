# LinkTargetLastModifiedDate Field


Other (Windows shortcut) document associated metadata field.
...
public const string LinkTargetLastModifiedDate = "LinkTargetLastModifiedDate"
```
