# SenderTelephoneNumber Field


Microsoft Outlook email voice/fax object (.msg) associated metadata.
...
public const string SenderTelephoneNumber = "SenderTelephoneNumber"
```
