# AgingDontAgeMe Field


Outlook email object associated metadata field (MAPI property PidLidAgingDontAgeMe).
...
public const string AgingDontAgeMe = "AgingDontAgeMe"
```
