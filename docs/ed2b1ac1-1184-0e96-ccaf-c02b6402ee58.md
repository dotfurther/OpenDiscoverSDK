# HasReferenceAttachment Field


Outlook email object has an attachment that is referenced by a fully qualified file system path.
...
public const string HasReferenceAttachment = "HasReferenceAttachment"
```
