# FreeBusyNonParticipantString Field


iCalendar free or busy non-participant attendees.
...
public const string FreeBusyNonParticipantString = "FreeBusyNonParticipantString"
```
