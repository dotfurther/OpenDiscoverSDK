# NumOfContainerItems Field


Archive (.7z, .zip, .rar, etc) and mail store (.pst, .ost, .mbox, etc) associated metadata.
...
**C#**
``` C#
[KnownMetadataAttribute(IsArchiveType = true, IsMailStoreType = true)]
public const string NumOfContainerItems = "NumOfContainerItems"
```
