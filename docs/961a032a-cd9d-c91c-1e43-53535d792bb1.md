# LastPrintedDate Field


Office, HTML (Dublic Core field, e.g., office document saved as HTML), and other document associated metadata field.
...
**C#**
``` C#
[KnownMetadataAttribute(IsOfficeType = true, IsHtmlType = true, IsOther = true)]
public const string LastPrintedDate = "LastPrintedDate"
```
