# TaskDeadOccurrence Field


Outlook email task object associated metadata field (MAPI property PidLidTaskDeadOccurrence).
...
public const string TaskDeadOccurrence = "TaskDeadOccurrence"
```
