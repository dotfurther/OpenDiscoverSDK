...
public class ArchiveContent : DocumentContent
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  <a href="8e86a5a1-9129-b079-8605-f7fa3f3a1f21">DocumentContent</a>  →  ArchiveContent</td></tr>
</table>



## Remarks
This class returns the folder internal hierarchy of an archive (if defined and supported by the format) and the count of stored items contained in the archive. To extract the items contained by the archive see the various interface methods defined in <a href="9d2fb8da-9eff-b1d9-e027-a4b2d24993e8">IArchiveExtractor</a>.
