# ConversationIndexDisplay Field


Microsoft Outlook email object (.msg) associated metadata. ConversationIndex MAPI byte array property parsed into a human readable string
...
public const string ConversationIndexDisplay = "ConversationIndexDisplay"
```
