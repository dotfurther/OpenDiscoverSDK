...
Represents a list of Boolean values document metadata property.
...
[KnownTypeAttribute(typeof(DocumentPropertyBase<List<bool>>))]
public class BooleanListProperty : DocumentPropertyBase<List<bool>>
```

<table><tr><td><strong>Inheritance</strong></td><td>Object  →  <a href="854c97ea-54ea-7894-e767-4da530bd8c60">DocumentPropertyBase</a>(List(Boolean))  →  BooleanListProperty</td></tr>
</table>
