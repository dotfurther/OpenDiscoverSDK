# IsSolidCompression Field


Archive (determines if archive uses solid compression blocks) associated metadata field.
...
public const string IsSolidCompression = "IsSolidCompression"
```
