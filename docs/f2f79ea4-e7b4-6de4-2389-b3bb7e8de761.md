# IsMultiMediaType Property


Gets or sets whether this metadata field is associated with multimedia metadata (e.g., music and video formats).
...
**C#**
``` C#
public bool IsMultiMediaType { get; set; }
```
