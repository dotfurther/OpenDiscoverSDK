# CurrentNumberOfArchivesInProcess Property


If a task is running, returns the current number of archives (Zip/7zip/Tar/Rar/etc) currently being processed.
...
**C#**
``` C#
public int CurrentNumberOfArchivesInProcess { get; }
```
